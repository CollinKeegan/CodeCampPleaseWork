...
public class Demo1Servo extends com.qualcomm.robotcore.eventloop.opmode.OpMode {
	...
	com.qualcomm.robotcore.hardware.Servo demoServo;
	...
	public void init() {
		...
		demoServo = hardwareMap.get(com.qualcomm.robotcore.hardware.Servo.class, "demoservo");
	}
