package org.firstinspires.ftc.teamcode.teamcode.Z.Controls;
...
public class JoystickControls {
    ...
    private java.util.Map<Input, Joystick> joysticks = new HashMap<>();
    private static java.util.List<JoystickControls> instances = new ArrayList<>();
